...
type SwitcherImageProps = {
    onImageOptionSelect?: (imageStatusId: string) => void;
};

const SwitcherImage: React.FC<SwitcherImageProps> = ({ onImageOptionSelect }) => {
    ...
    const handleToggle = () => {
        ...
        if (onImageOptionSelect) {
            onImageOptionSelect(newStatus ? "1" : "0");
        }
    };
