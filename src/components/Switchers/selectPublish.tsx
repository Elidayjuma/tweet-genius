...
type SwitcherThreeProps = {
    onOptionSelect?: (statusId: string) => void;

};

const SwitcherThree: React.FC<SwitcherThreeProps> = ({ onOptionSelect }) => {
    ...
    const handleToggle = () => {
        ...
        if (onOptionSelect) {
            onOptionSelect(newStatus ? "1" : "0"); // Send the status to the parent
        }
